...
from model.D3d import Discriminator
from model.G3d import Generator
import numpy as np
...
real_A = torch.FloatTensor(opt.batchSize, 1, input_nc, fineSize, fineSize)
real_B = torch.FloatTensor(opt.batchSize, 1, input_nc, fineSize, fineSize)
