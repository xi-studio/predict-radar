...
class Generator(nn.Module):
    ...
    def forward(self,x):
        ...
        return out
        '''
        self.conv1 = nn.Conv2d(input_nc, ngf, 5, 1, 2)
        self.conv2 = nn.Conv2d(ngf, ngf * 2, 5, 1, 2)
        ...
        self.dconv7 = nn.ConvTranspose2d(ngf * 2 * 2, ngf, 5, 1, 2)
        self.dconv8 = nn.ConvTranspose2d(ngf * 2, output_nc, 5, 1, 2)
